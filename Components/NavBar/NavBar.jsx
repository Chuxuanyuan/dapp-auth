...
const NavBar = () => {
    ...
    const { account, userName, connectWallet, create, error } = useContext(AuthContect);
            ...
            {openModel && (
                <div className={Style.modelBox}>
                    <Model 
                        ...
                        title="WELCOME TO"
                        head="DAPP AUTHENTICATION"
                        info="This is part of the project."
                        smallInfo="Academic Year 2022"
                        image={images.hero}
                        functionName={create}
                        address={account}
                    />
